...
export const artistBioMetal = [
	...
	},
	{
		...
		band: 'Sacred Reich',
		bio: [
			'<strong>Sacred Reich</strong> is a German thrash metal band formed in <strong>1985</strong>. The band is known for its <strong>intense live performances and aggressive sound</strong>.',
			'They gained attention with albums such as <strong>Reign in Blood (1987)</strong> and <strong>The New Order (1989)</strong>.',
			'Their music features fast-paced guitar riffs, powerful vocals, and politically charged themes.',
			'Sacred Reich has been influential in the thrash metal scene and continues to be active.',
			'They are known for their energetic live shows and dedicated fanbase.',
			'Sacred Reich is considered one of the <strong>most impactful bands in German thrash metal</strong>.',
		],
	},
	{
		id: 33,
