...
export const artistBioMetal = [
	...
	},
	{
		...
		band: 'Sacred Reich',
		bio: [
			'<strong>Rainbow</strong> is a British rock band formed in <strong>1975 by Ritchie Blackmore</strong> after leaving Deep Purple. The band played a key role in shaping <strong>hard rock and early heavy metal</strong>.',
			'Early lineups featured <strong>Ronnie James Dio</strong>, whose vocals defined albums such as <strong>Rising (1976)</strong>.',
			'Rainbow combined classical influences with heavy guitar riffs and fantasy-based lyrics.',
			'The band underwent several lineup changes and musical shifts over the years.',
			'They achieved both critical and commercial success during the late 1970s and 1980s.',
			'Rainbow remains a <strong>highly influential band in rock and metal history</strong>.',
		],
	},
	{
		id: 33,
