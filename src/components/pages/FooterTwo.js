...
import { socialLinks, logo, pageLinks } from '../../data'
		...
		<footer className='section footer'>
			...
			<div className='text-center'>
				<p className='copyright'>
					...
					<br />
					<strong>Disclaimer:</strong> This website may contain links to external websites. We are not responsible for
					the content, accuracy, or availability of these external sites, nor do we endorse any views or information
					presented on them. Accessing external links is at your own risk.
				</p>
				<p className='copyright'>
